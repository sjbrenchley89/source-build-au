  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      tl.fromTo('.name-reveal', { opacity: 0, y: 50 }, { opacity: 1, y: 0, duration: 1.2, delay: 0.1 })
        .fromTo('.blur-in', { opacity: 0, filter: 'blur(10px)', y: 20 }, { opacity: 1, filter: 'blur(0px)', y: 0, duration: 1, stagger: 0.1, delay: 0.1 }, '<0.3')
    })
    return () => ctx.revert()
  }, [])
  ...
  return (
    <section className="relative w-full h-screen overflow-hidden flex items-center justify-center">
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 max-w-4xl">
        ...
        <p className="blur-in text-sm md:text-base text-muted max-w-lg mb-12 opacity-0">
          We source, coordinate and supply the right building products for your project —
          to your specifications, within your budget, by your delivery date.
          Backed by our <span className="text-text-primary/80">Complete Satisfaction Supply Guarantee</span>.
        </p>

        <div className="blur-in inline-flex flex-wrap justify-center gap-4 opacity-0">

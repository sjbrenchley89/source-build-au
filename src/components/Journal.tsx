...
const STEPS = [
  {
    id: '01',
    title: 'Specification',
    desc: 'Tell us exactly what you need — product type, tolerances, performance requirements, and project scope.',
  },
  {
    id: '02',
    title: 'Sourcing',
    desc: 'We match your spec to the right global supplier, balancing quality, cost, and lead time — always AU/NZ compliant.',
  },
  {
    id: '03',
    title: 'Manufacture',
    desc: 'Factory production with hold-point inspections, third-party QA, and full certification documentation included.',
  },
  {
    id: '04',
    title: 'Logistics',
    desc: 'We manage customs, freight, insurance, and compliance — one point of contact, real-time tracking end to end.',
  },
  {
    id: '05',
    title: 'Delivery',
    desc: 'Products land on site labelled, staged, and sequenced — install-ready on day one, no rework required.',
  },
  {
    id: '06',
    title: 'Support',
    desc: 'Post-install, we own the outcome — warranty management, defect response, and full project close-out support.',
  },
]
        ...
        >
          <div>
            ...
            <p className="text-sm text-muted max-w-sm">
              Six steps. Zero surprises. Full accountability from spec to site.
            </p>
          </div>
